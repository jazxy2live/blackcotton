...
- Strict+high-noise top success: `0.050` -> `0.267` (delta `+0.217`)
- Strict+high-noise top robust score: `0.295` -> `0.455` (delta `+0.160`)
...
|---|---:|---:|---:|
| baseline | 0.325 | 0.779 | +0.454 |
| strict_gate | 0.013 | 0.342 | +0.329 |
| high_noise | 0.271 | 0.600 | +0.329 |
| strict_high_noise | 0.050 | 0.217 | +0.167 |
